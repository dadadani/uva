# Generated @ 2023-11-11T20:58:59+01:00
# Command line:
#   /home/daniele/.nimble/pkgs2/nimterop-0.6.13-a93246b2ad5531db11e51de7b2d188c42d95576a/nimterop/toast --preprocess -m:c --includeDirs+=/home/daniele/.cache/nim/nimterop/libuv/include --pnim --symOverride=uv__queue,uv__io_t,uv__work,UV_REQ_PRIVATE_FIELDS,UV_SHUTDOWN_PRIVATE_FIELDS,UV_HANDLE_PRIVATE_FIELDS,UV_STREAM_PRIVATE_FIELDS,UV_WRITE_PRIVATE_FIELDS,UV_TCP_PRIVATE_FIELDS,UV_CONNECT_PRIVATE_FIELDS,UV_UDP_PRIVATE_FIELDS,UV_TTY_PRIVATE_FIELDS,UV_PIPE_PRIVATE_FIELDS,UV_POLL_PRIVATE_FIELDS,UV_PREPARE_PRIVATE_FIELDS,UV_CHECK_PRIVATE_FIELDS,UV_IDLE_PRIVATE_FIELDS,UV_ASYNC_PRIVATE_FIELDS,UV_TIMER_PRIVATE_FIELDS,UV_GETADDRINFO_PRIVATE_FIELDS,UV_GETNAMEINFO_PRIVATE_FIELDS,UV_PROCESS_PRIVATE_FIELDS,UV_WORK_PRIVATE_FIELDS,UV_DIR_PRIVATE_FIELDS,UV_FS_PRIVATE_FIELDS,UV_FS_EVENT_PRIVATE_FIELDS,UV_SIGNAL_PRIVATE_FIELDS,UV_LOOP_PRIVATE_FIELDS,uvx_queue,uvx_io_t,uvx_work,uv__queue,uv__io_t,uv__work,UV_REQ_PRIVATE_FIELDS,UV_SHUTDOWN_PRIVATE_FIELDS,UV_HANDLE_PRIVATE_FIELDS,UV_STREAM_PRIVATE_FIELDS,UV_WRITE_PRIVATE_FIELDS,UV_TCP_PRIVATE_FIELDS,UV_CONNECT_PRIVATE_FIELDS,UV_UDP_PRIVATE_FIELDS,UV_TTY_PRIVATE_FIELDS,UV_PIPE_PRIVATE_FIELDS,UV_POLL_PRIVATE_FIELDS,UV_PREPARE_PRIVATE_FIELDS,UV_CHECK_PRIVATE_FIELDS,UV_IDLE_PRIVATE_FIELDS,UV_ASYNC_PRIVATE_FIELDS,UV_TIMER_PRIVATE_FIELDS,UV_GETADDRINFO_PRIVATE_FIELDS,UV_GETNAMEINFO_PRIVATE_FIELDS,UV_PROCESS_PRIVATE_FIELDS,UV_WORK_PRIVATE_FIELDS,UV_DIR_PRIVATE_FIELDS,UV_FS_PRIVATE_FIELDS,UV_FS_EVENT_PRIVATE_FIELDS,UV_SIGNAL_PRIVATE_FIELDS,UV_LOOP_PRIVATE_FIELDS --nim:/home/daniele/.choosenim/toolchains/nim-1.6.14/bin/nim --pluginSourcePath=/home/daniele/.cache/nim/nimterop/cPlugins/nimterop_870580418.nim /home/daniele/.cache/nim/nimterop/libuv/include/uv.h -o /home/daniele/.cache/nim/nimterop/toastCache/nimterop_2798336208.nim

# const 'UV_EXTERN' has unsupported value '__attribute__((visibility("default")))'
# type 'uv__queue' skipped
# tree-sitter parse error: 'typedef enum {', skipped
# tree-sitter parse error: 'typedef enum {', skipped
# const 'UV_MAXHOSTNAMESIZE' has unsupported value '(MAXHOSTNAMELEN + 1)'
{.push hint[ConvFromXtoItselfNotNeeded]: off.}
import uv_compile, errno, os
export errno
import macros
...
{.pragma: impuvHdr,
  header: currentSourcePath() / ".." / "libuv/include/uv.h".}
...
when defined windows:
    ...
    from winlean import AddrInfo, SockAddr, SockAddr_in, SockAddr_in6, Handle, SocketHandle
    export AddrInfo, SockAddr, Sockaddr_in
    type uv_uid_t* = cuchar
    type uv_gid_t* = cuchar
    type uv_os_fd_t* = Handle
    type uv_os_sock_t* = SocketHandle
    type uv_pid_t* = cint
    type uv_mutex_t* = pointer
    type uv_rwlock_t* = pointer
    type uv_sem_t* = Handle
    type uv_cond_t* = pointer
    type uv_barrier_t* = pointer
    type uv_once_t* = pointer
    type uv_key_t* = pointer
    type uv_thread_t* = Handle
else:
    from posix import AddrInfo, SockAddr, Uid, Gid, SockAddr_in, SockAddr_in6, Pid, Pthread_mutex, Pthread_rwlock, Pthread_cond, Pthread_once, Pthread_key, Pthread
    export AddrInfo, SockAddr, Sockaddr_in
    type uv_uid_t* = Uid
    type uv_gid_t* = Gid
    type uv_os_fd_t* = cint
    type uv_file* = cint
    type uv_os_sock_t* = cint
    type uv_pid_t* = Pid
    type uv_mutex_t* = Pthread_mutex
    type uv_rwlock_t* = Pthread_rwlock
    type uv_sem_t* = pointer
    type uv_cond_t* = Pthread_cond
    type uv_barrier_t* = pointer
    type uv_once_t* = Pthread_once
    type uv_key_t* = Pthread_key
    type uv_thread_t* = Pthread

type uv_lib_t* {.bycopy, impuvHdr, importc: "struct uv_lib_t".} = object
    handle*: pointer
    errmsg*: cstring
